...
@section('content')
    ...
    <section class="bg-light py-5">
        <a href="{{ route('dashboard') }}" class="m-4 btn btn-outline-primary">Go back</a>
        <div class="col">
            <div class="container px-5 my-5 px-5">
                <div class="row gx-5 justify-content-center">
                    ...
                    @if ($ticket->status == 'closed')
                        <p class="text-danger text-center">This ticket have been closed and cant accept any reply again</p>
                    @else
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div>
                                ...
                                <img src="..." class="img-fluid rounded-start" alt="...">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            <h5 class="card-title">{{ $reply->subject }} <span
                                                    class="badge rounded-pill bg-info">{{ $reply->user_type }} </span>
                                            </h5>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small class="text-muted">{{ $ticket->status }}</small>
                                    </p>
                                    @if ($ticket->status == 'closed')

                                    @else
                                        <a href="{{ route('admin.closed_ticket', $ticket->id) }}"
                                            class="  btn btn-warning" type="button">Closed Ticket</a>
                                    @endif
